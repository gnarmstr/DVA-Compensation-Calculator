namespace DVA_Compensation_Calculator
{
	partial class Knee
	{
		...
		private void InitializeComponent()
		{
			...
			this.comboBoxKneesPartially = new System.Windows.Forms.ComboBox();
			...
			this.checkBoxOption2.Location = new System.Drawing.Point(39, 303);
			...
			this.checkBoxOption4.Location = new System.Drawing.Point(39, 439);
			...
			this.checkBoxOption5.Location = new System.Drawing.Point(39, 514);
			...
			this.checkBoxOption3.Location = new System.Drawing.Point(39, 369);
			...
			this.checkBoxOption1.Location = new System.Drawing.Point(39, 243);
			...
			this.checkBoxOption6.Location = new System.Drawing.Point(39, 592);
			...
			this.pictureBoxCancel.Location = new System.Drawing.Point(621, 608);
			...
			this.pictureBoxOK.Location = new System.Drawing.Point(517, 608);
			...
			this.panel1.Controls.Add(this.comboBoxKneesPartially);
			...
			this.panel1.Size = new System.Drawing.Size(720, 706);
			...
			this.label3.Location = new System.Drawing.Point(35, 663);
        ...
        "ccepted condition is fully covered.");
			// 
			// comboBoxKneesPartially
			// 
			this.comboBoxKneesPartially.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBoxKneesPartially.FormattingEnabled = true;
			this.comboBoxKneesPartially.Items.AddRange(new object[] {
            "Complete",
            "About 3/4",
            "About 2/3",
            "About 1/2",
            "About 1/3",
            "About 1/4"});
			this.comboBoxKneesPartially.Location = new System.Drawing.Point(333, 660);
			this.comboBoxKneesPartially.Name = "comboBoxKneesPartially";
			this.comboBoxKneesPartially.Size = new System.Drawing.Size(142, 28);
			this.comboBoxKneesPartially.TabIndex = 27;
			this.toolTip1.SetToolTip(this.comboBoxKneesPartially, "Partially contributing impairment is to be applied whenever an impairment is not " +
        "due solely to the effects of the accepted condition.\r\n\"Complete\" indicates the a" +
        "ccepted condition is fully covered.");
			// 
			// label2
			...
			this.buttonMainTitle.Location = new System.Drawing.Point(22, 16);
			this.buttonMainTitle.Name = "buttonMainTitle";
			this.buttonMainTitle.Size = new System.Drawing.Size(671, 43);
			...
			this.pictureBoxClose.Location = new System.Drawing.Point(699, 16);
			...
			this.MaximumSize = new System.Drawing.Size(770, 800);
			this.MinimumSize = new System.Drawing.Size(770, 800);
			this.Name = "Knee";
		...
		private System.Windows.Forms.ComboBox comboBoxKneesPartially;
