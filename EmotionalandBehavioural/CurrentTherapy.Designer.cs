namespace DVA_Compensation_Calculator
{
	partial class CurrentTherapy
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CurrentTherapy));
    ...
    " commenced, may be recognised as being of use.";
			...
			this.checkBoxOption7.Text = "Continuous psychiatric treatment is essential, with a need for long periods in ho" +
    "spital and marked social support.";
			...
			this.checkBoxOption4.Text = "Psychiatric treatment, at least in the form of medication or psychotherapy, has b" +
    "een used (or deemed necessary), and/or periods of regular supportive therapy at " +
    "an outpatient level or similar.";
			...
			this.checkBoxOption5.Text = "Need for intensive specialist psychiatric treatment on an outpatient basis, inclu" +
    "ding medication and/or inpatient hospital care for short periods.";
			...
			this.checkBoxOption1.Text = "No regular treatment sought or recommended.";
			...
			this.checkBoxOption6.Text = "Longer periods of in-patient hospital care are necessary. Long term psychotropic " +
    "drug regimes or ECT is being undertaken.";
