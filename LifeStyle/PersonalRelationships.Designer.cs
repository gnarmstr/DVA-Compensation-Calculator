namespace DVA_Compensation_Calculator
{
    ...
    ".";
			this.checkBoxPersonalRelations1.UseVisualStyleBackColor = false;
    ...
    "sual acquaintances.";
			this.checkBoxPersonalRelations4.UseVisualStyleBackColor = false;
    ...
    "uality.";
			this.checkBoxPersonalRelations6.UseVisualStyleBackColor = false;
			...
			this.checkBoxPersonalRelations5.UseVisualStyleBackColor = false;
    ...
    "estricted.";
			this.checkBoxPersonalRelations3.UseVisualStyleBackColor = false;
    ...
    "personal activities.";
			this.checkBoxPersonalRelations2.UseVisualStyleBackColor = false;
			...
			this.checkBoxPersonalRelations7.UseVisualStyleBackColor = false;
			...
			this.checkBoxPersonalRelations8.UseVisualStyleBackColor = false;
    ...
    "at best meets your situation.";
			...
			this.panel1.Controls.Add(this.checkBoxPersonalRelations7);
			this.panel1.Controls.Add(this.checkBoxPersonalRelations8);
			this.panel1.Controls.Add(this.pictureBoxCancel);
			this.panel1.Controls.Add(this.pictureBoxOK);
			this.panel1.Controls.Add(this.checkBoxPersonalRelations2);
			this.panel1.Controls.Add(this.checkBoxPersonalRelations3);
			this.panel1.Controls.Add(this.checkBoxPersonalRelations5);
			...
			this.MinimumSize = new System.Drawing.Size(980, 1000);
