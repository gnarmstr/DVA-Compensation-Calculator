namespace DVA_Compensation_Calculator
{
	partial class Tinnitus
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBoxOption2.Text = "Very mild tinnitus: not present every day.";
			...
			this.checkBoxOption4.Text = "Severe tinnitus, eg of similar severity to that requiring a masking device, prese" +
    "nt every day.";
			...
			this.checkBoxOption3.Text = "Tinnitus every day, but tolerable for much of the time.";
			...
			this.checkBoxOption1.Text = "No tinnitus or occasional tinnitus.";
