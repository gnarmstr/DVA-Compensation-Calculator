namespace DVA_Compensation_Calculator
{
	partial class ThoracoROM
	{
		...
		private void InitializeComponent()
		{
			...
			this.comboBoxThoracoROMPartially = new System.Windows.Forms.ComboBox();
			...
			this.checkBoxOption2.Location = new System.Drawing.Point(23, 174);
			...
			this.checkBoxOption4.Location = new System.Drawing.Point(23, 310);
			...
			this.checkBoxOption5.Location = new System.Drawing.Point(23, 382);
			...
			this.checkBoxOption3.Location = new System.Drawing.Point(23, 240);
			...
			this.checkBoxOption1.Location = new System.Drawing.Point(23, 114);
			...
			this.checkBoxOption1.Text = "X-ray changes only. Normal or nearly normal range of movement.";
			...
			this.checkBoxOption6.Location = new System.Drawing.Point(23, 459);
			...
			this.pictureBoxCancel.Location = new System.Drawing.Point(617, 534);
			...
			this.pictureBoxOK.Location = new System.Drawing.Point(512, 534);
			...
			this.panel1.Controls.Add(this.comboBoxThoracoROMPartially);
			...
			this.toolTip1.SetToolTip(this.panel1, "Partially contributing impairment is to be applied whenever an impairment is not " +
        ...
        "pted condition is fully covered.");
			// 
			// comboBoxThoracoROMPartially
			// 
			this.comboBoxThoracoROMPartially.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBoxThoracoROMPartially.FormattingEnabled = true;
			this.comboBoxThoracoROMPartially.Items.AddRange(new object[] {
            "Complete",
            "About 3/4",
            "About 2/3",
            "About 1/2",
            "About 1/3",
            "About 1/4"});
			this.comboBoxThoracoROMPartially.Location = new System.Drawing.Point(340, 564);
			this.comboBoxThoracoROMPartially.Name = "comboBoxThoracoROMPartially";
			this.comboBoxThoracoROMPartially.Size = new System.Drawing.Size(142, 28);
			this.comboBoxThoracoROMPartially.TabIndex = 61;
			this.toolTip1.SetToolTip(this.comboBoxThoracoROMPartially, "Partially contributing impairment is to be applied whenever an impairment is not " +
        "due solely to the effects of the accepted condition.\r\n\"Complete\" indicates the a" +
        "ccepted condition is fully covered.");
			// 
			// toolTip1
			...
			this.buttonMainTitle.Location = new System.Drawing.Point(41, 23);
			this.buttonMainTitle.Name = "buttonMainTitle";
			this.buttonMainTitle.Size = new System.Drawing.Size(661, 43);
			...
			this.pictureBoxClose.Location = new System.Drawing.Point(708, 23);
			...
			this.MaximumSize = new System.Drawing.Size(800, 740);
		...
		private System.Windows.Forms.ComboBox comboBoxThoracoROMPartially;
